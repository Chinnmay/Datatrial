...
main_data  = pd.read_csv('/home/sarvasva/Documents/BE-project/Text Emotion/main_data.csv')
#print(main_data)
...
#			print( "right " , max(counts.items(), key=operator.itemgetter(1))[0] )
	...
	i += 1
	#print(counts)
	print( "Stronger Emotion -- >" , max(counts.items(), key=operator.itemgetter(1))[0] )
